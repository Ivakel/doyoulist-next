    ...
    <>
      {navigationLinks.map((link, key) => {
        return (
          <span
            key={link.content}
            className="relative w-24 h-[2.6rem] my-auto cursor-pointer rounded-md hover:bg-slate-100"
          >
            <button
              className="flex justify-center content-center align-middle h-[2.6rem] w-24"
