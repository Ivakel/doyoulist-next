...
export default function page() {
  ...
  const todayComponent = (
    <button className="flex hover:bg-[#D9D9D9] rounded-md p-2 transition-colors duration-300">
      <div className="relative">
        <Image
          ...
          alt="date icon"
        />
        <span className="absolute flex flex-col top-[0.8rem] left-[.54rem] h-min gap-[-4px]">
          <h3 className="text-[#575293] font-semibold text-sm">{weekday}</h3>
          <h3 className="mt-[-0.4rem] mx-auto text-sm text-[#8C83C9] tracking-wider">
            {day}
          </h3>
        </span>
      </div>
      <div>
        <div className="list-none flex">
          <div className="p-1">
            ...
            <hr />
            <h3 className="font-medium text-[0.6rem] text-slate-500 ml-1 text-left">
              {
