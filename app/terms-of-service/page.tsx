        ...
        <div className="rounded-md p-6 shadow">
            ...
            <section>
                ...
                <p>
                    ...
                    other managing authority. Country refers to: Ontario, Canada
                    Company (referred to as either the Company, We, Us or Our in
                    this Agreement) refers to PANDEM INC., 7014 Dunrobin Way
                    Mississauga L5N6Y4. Device means any device that can access
                    the Service such as a computer, a cellphone or a digital
                    tablet. Service refers to the Website. Terms and Conditions
                    ...
                    Conditions Generator. Third-party Social Media Service means
                    ...
                    Website refers to Pandem, accessible from http://pandem.dev/
            ...
            <section>
                ...
                the age of 18. The Company does not permit those under 18 to use
            ...
            <h2 className="mb-2 mt-4 text-2xl font-semibold">Termination</h2>
            <p>
            ...
            <p>
                ...
                components. Some jurisdictions do not allow the exclusion of
            ...
            <h2 className="mb-2 mt-4 text-2xl font-semibold">Governing Law</h2>
            <p>
            ...
            <h2 className="mb-2 mt-4 text-xl font-semibold">Severability</h2>
            <p>
            ...
            <h2 className="mb-2 mt-4 text-xl font-semibold">Waiver</h2>
            <p>
